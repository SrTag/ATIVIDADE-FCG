...
//#endif
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		shader.setVec4("inputColor", 255.0f, 255.0f, 0.0f, 1.0f);
		...
		shader.setVec4("inputColor", 0.5f, 0.5f, 1.0f, 1.0f);
...
int setupGeometry()
{
	...
	GLfloat vertices[] = {//EX 3-LISTA 2
		  ...
		  0.0f * 300 + 400, -0.5f * 300 + 300, 0.0f, // direita >
		 -0.75f * 300 + 400, -0.5f * 300 + 300, 0.0f, // esquerda <
		 -0.5f * 300 + 400, 0.5f * 300 + 300, 0.0f, //cima ^

		 //outro triangulo vai aqui
		 0.0f * 300 + 400, -0.5f * 300 + 300, 0.0f, //<
		 0.55f * 300 + 400, 0.5f * 300 + 300, 0.0f, // ^
		 0.9f * 300 + 400, -0.5f * 300 + 300, 0.0f, //>

...
void Tilemap::draw()
{
	...
	posDoBloco.x = xi + pos.x * tileDimensions.x;
	posDoBloco.y = yi + pos.y * tileDimensions.y;
...
glm::vec3 Tilemap::GetPosBloco()
{
	return this->posDoBloco;
}
...
int Tilemap::getMap(int PosX, int PosY)
{

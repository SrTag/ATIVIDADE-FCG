...
//-----------------------------------------------------------------------
float Xscale = 100.0f, Yscale = 100.0f, Xpos = 0.0f, Ypos = 0.0f;
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model[0] = glm::translate(model[0], glm::vec3(Xpos, Ypos, -95.0f));
		
		//(2)rotação
		model[0] = glm::rotate(model[0], /*glm::radians(90.0f)*/(float)glfwGetTime(), glm::vec3(0, 1, 0));
		//(3)aplicando a escala
		model[0] = glm::scale(model[0], glm::vec3(30.0f, 30.0f, 30.0f));
